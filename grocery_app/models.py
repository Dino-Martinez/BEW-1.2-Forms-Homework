...
class GroceryItem(db.Model):
    ...
    created_by_id = db.Column(db.Integer, db.ForeignKey('user.id'))
    created_by = db.relationship('User')
    users_with_this_in_cart = db.relationship('User', secondary='shopping_cart', back_populates='cart_items')
...
class User(UserMixin, db.Model):
    ...
    cart_items = db.relationship('GroceryItem', secondary='shopping_cart', back_populates='users_with_this_in_cart')
